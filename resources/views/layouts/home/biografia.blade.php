...
@section('biografia')
    <p>
        ...
        Despues realizaria un tecnologo en mantenimiento de equipos de Computo, diseño e instalacion de cableado estructurado en el SENA, iniciando asi mi vida laboral en el Grupo Op Graficas, pasados unos meses iniciaria sevicio militar el 15 de marzo del 2015, luego de un año continuaria nuevamente mis estudios esta vez en Ingenieria de software en la fundacion Universitaria Unipanamericana, actualmente me encuentro cursando septimo Semestre.
    </p>
@endsection('biografia')